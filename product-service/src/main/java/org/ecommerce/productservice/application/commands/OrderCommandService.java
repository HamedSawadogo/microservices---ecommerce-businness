...
public class OrderCommandService {
  ...
  private final ProductRepository productRepository;
    ...
    // @Transactional
    //TODO this code is very wrong a big fail there is concurrency no Lock in database
    // TOOO use Redis or Database Pessimistic Lock

    /** public ResourceCreatedId addOrderItem(CreateOrderItemRequest request) throws InterruptedException {
      Long userId = 1L;
